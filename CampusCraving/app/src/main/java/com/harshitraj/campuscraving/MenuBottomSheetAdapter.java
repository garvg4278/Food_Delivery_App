...
public class MenuBottomSheetAdapter extends RecyclerView.Adapter<MenuBottomSheetAdapter.MenuViewHolder>{
    ...
    public MenuBottomSheetAdapter(ArrayList<String> foodNameList, ArrayList<String> foodPriceList, ArrayList<Integer> foodImageList) {
