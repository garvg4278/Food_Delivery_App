...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RestaurantName = findViewById(R.id.editTextRestaurant);
        Password = findViewById(R.id.editTextPassword2);
        Email = findViewById(R.id.restaurantName);
        createAccount = findViewById(R.id.createNewUserButton);
        ...
        createAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                signUpFirebase(userName,restaurantName,userEmail,userPassword);
            }
        });
    ...
    public void signUpFirebase(String userName,String restaurantName, String userEmail, String userPassword){
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            User user = new User(userName,restaurantName ,userEmail);
